...
AWSCognito.config.region = 'us-west-2';
    var identityPoolId = 'ScoutSuite';
    var poolData = {
            UserPoolId : 'us-west-2_Z4fsUK1DG',
            ClientId : '13mkeesrb9klo5dgfv5evgj3av'
        };
  ...
  */
  ...
  $(function() {
     ...
     $(document).ready(function () {
           $('#scout_nav_up').hide();
           $('#scoutsuite_navbar').hide();
           $('#scoutsuite_up_settings').hide()
           $('#report-footer').hide()
           $('#page_backward').hide()
           $('#page_forward').hide()
          ...
          cognitoUser.authenticateUser(authenticationDetails, {
              onSuccess: function (result) {
               ...
               if (err) {
                ...
                $('#signupBtn').hide();
                $('#scout_nav_up').show();
                $('#scoutsuite_navbar').show();
                $('#scoutsuite_up_settings').show();
                $('#report-footer').show();
                $('#page_backward').show()
                $('#page_forward').show()
